            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
                    <div className="animate__animated animate__fadeInUp animate__delay-3s">
                        ...
                        <BlurText text="A Software Engineering student who believes technology is powerful when ideas are shared and voices are heard. I build digital solutions while also using communication and public speaking to inspire others, connect communities, and create meaningful impact." delay={150} animateBy="words" direction="top" className=" mb-6" />
                        <div className="flex items-center sm:gap-4 gap-2">
                            <a href="./cv-april.pdf" download className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors">
                    ...
                    <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
                        <ProfileCard name="Melly Apriliya" title="Web Developer" handle="aprlsarchives" status="Online" contactText="Contact Me" avatarUrl={melly} showUserInfo={true} enableTilt={true} enableMobileTilt={false} onContactClick={() => console.log("Contact clicked")} />
                    </div>
                </div>
                {/* tentang */}
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
                        <div className="w-full">
                            ...
                            <div className="flex-1 text-left">
                                ...
                                <BlurText
                                    text="Hi, I'm Melly Apriliya, a Software Engineering student who is passionate about building technology and empowering people through communication.
                ...
                <div className="kontak mt-32 sm:p-10 p-0" id="contact">
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="flex-1 bg-zinc-800 p-6 rounded-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" data-aos-once="true">
                            <h2 className="text-2xl font-bold mb-4">Let's Create Impact Together</h2>

                            <p className="text-zinc-300 leading-relaxed">I’m passionate about technology, communication, and community engagement.</p>

                            <p className="text-zinc-300 leading-relaxed mt-3">As a Software Engineering student, I enjoy building digital solutions while also sharing ideas, inspiring others, and connecting people through public speaking and collaboration.</p>

                            <p className="text-zinc-300 leading-relaxed mt-3">I believe technology becomes meaningful when it brings people together and creates real impact.</p>
                        ...
                        <div className="flex-1">
                            <form action="https://formsubmit.co/mellyapril666@gmail.com" method="POST" className="bg-zinc-800 p-10 w-full rounded-md" autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
